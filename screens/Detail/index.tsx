  ...
  return !isLoading ? (
    <Container>
      <ScrollView contentContainerStyle={styles.ScrollView}>
        ...
        <Spliter />
        <View style={[globalStyles.Flex, { marginLeft: 25, marginRight: 25 }]}>
          ...
          <View style={[globalStyles.Flex1]}>
            ...
            <MetaScoreLabel>
              <Text style={{ fontSize: 20, color: '#fff' }}>{imdbRating}</Text>{' '}
              / 10
            </MetaScoreLabel>
            <CriticalViewWrapper>
              <CriticalViews>53 Critic Reviews</CriticalViews>
          ...
          <View style={[globalStyles.Flex1]}>
            <MetaScoreWrapper>
              <IconMovie source={require('../../assets/icon-movie.png')} />
            </MetaScoreWrapper>
        ...
        >
          <SectionHeader moreText="SEE ALL">Full Cast & Crew</SectionHeader>
